...
type ServiceSpec struct {
	...
	// and they will override the UserValues if colliding.
	Values string `json:"values,omitempty"`

	// UserValues are the values provided by the user.
	// The Values provided by the operator will overwrite these values.
